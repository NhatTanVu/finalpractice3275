package com.example.finalpractice.web;
...
public class StudentController {
    ...
    public String students(Model model, ModelMap mm,
    ...
    public String save(Model model, Student student, BindingResult bindingResult,
